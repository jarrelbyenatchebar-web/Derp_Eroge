label scene_0_prologue:
    ...
    # Shinji writing something in the papers

    sd "And...     Done."

    mngr "Congratulations on adopting your new son"

    mngr "May your bond together be as strong like a real famly"

    sd "Thank you.  lets go, [mc_name]"


    # both walks out the office

    sd "Your name is [mc_name] right? do you have any nickname you prefered to be called?"

    mc "nope"

    sd "okay, My name is Shinji, Your new Foster father"
